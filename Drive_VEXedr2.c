#pragma config(Sensor, in1,    claw_roll,      sensorPotentiometer)
#pragma config(Sensor, in2,    claw_pitch,     sensorPotentiometer)
...
#pragma config(Motor,  port6,           claw_pitch,    tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port9,           claw_roll,     tmotorVex393_MC29, openLoop)
